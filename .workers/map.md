...
| tx-atomicity-recovery | availability (2) | reentrant deadlock | pending dossier | RED confirmed — parent-handle db.query inside a transaction callback deadlocks the instance (non-reentrant mutex). `runs/tx-atomicity-recovery-reentrant.md` |
